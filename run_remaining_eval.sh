...
echo "Bắt đầu chạy: uv run python eval/eval_previous_task.py --model_path Qwen/Qwen2.5-7B-Instruct --output_dir outputs/base_prior_eval"
echo "================================================================================"
...
echo "Bắt đầu chạy: uv run python eval/eval_science.py --model_path outputs/sdft-qwen2.5-7b-merged --output_dir outputs/sdft_science_eval"
echo "================================================================================"
...
echo "Bắt đầu chạy: uv run python eval/eval_previous_task.py --model_path outputs/sdft-qwen2.5-7b-merged --output_dir outputs/sdft_prior_eval"
echo "================================================================================"
